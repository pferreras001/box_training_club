<section class="section section__aviso_legal">
  <div class="aviso_legal__container container">
    <div>
      <h1>AVISO LEGAL</h1>
      <h2>LEY DE LOS SERVICIOS DE LA SOCIEDAD DE LA INFORMACIÓN (LSSI)</h2><br><br>

      <span>BOX TRAINING DONOSTIA, S.L.</span>, responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSICE), así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.<br><br>
      ...
      <span>BOX TRAINING DONOSTIA, S.L.</span> se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente con la publicación en el sitio web de <span>BOX TRAINING DONOSTIA, S.L</span><br><br>

      <h2>1. DATOS IDENTIFICATIVOS</h2><br><br>

      Denominación social: <span>BOX TRAINING DONOSTIA, S.L.</span><br>
      Nombre comercial: <span>BOX TRAINING CLUB</span><br>
      CIF: <span>B068296334</span><br>
      Domicilio: <span>PASEO MAGDALENA JAUREGIBERRI 4, LOCAL 1-G 20014 - DONOSTIA</span><br>
      e-mail: <span>info@boxtrainingclub.com</span><br><br>

      <h2>2. OBJETO</h2><br><br>

      A través del Sitio Web, les ofrecemos a los Usuarios la posibilidad de acceder a la información sobre nuestros servicios.<br><br>

      <h2>3. PRIVACIDAD Y TRATAMIENTO DE DATOS</h2><br><br>

      Cuando para el acceso a determinados contenidos o servicio sea necesario facilitar datos de carácter personal, los Usuarios garantizarán su veracidad, exactitud, autenticidad y vigencia. La empresa dará a dichos datos el tratamiento automatizado que corresponda en función de su naturaleza o finalidad, en los términos indicados en la sección de Política de Privacidad.<br><br>

      <h2>4. PROPIEDAD INDUSTRIAL E INTELECTUAL</h2><br><br>
      ...
      <h2>5. OBLIGACIONES Y RESPONSABILIDADES DEL USUARIO DEL ESPACIO WEB</h2><br><br>
      ...
      <h2>6. RESPONSABILIDADES</h2><br><br>
      ...
      Se podrá interrumpir el servicio, o resolver de modo inmediato la relación con el Usuario, si se detecta que un uso de su Espacio Web, o de cualquiera de los servicios ofertados en el mismo, es contrario a las presentes Condiciones Generales de Uso. No nos hacemos responsables por daños, perjuicios, pérdidas, reclamaciones o gastos derivados del uso del Espacio Web.<br><br>
 
      Únicamente será responsable de eliminar, lo antes posible, los contenidos que puedan generar tales perjuicios, siempre que así se notifique. En especial no seremos responsables de los perjuicios que se pudieran derivar, entre otros, de:<br><br>
      ...
      Para utilizar algunos de los Servicios, el Usuario debe proporcionar previamente ciertos datos de carácter personal. La empresa tratará automatizadamente estos datos y aplicará las correspondientes medidas de seguridad, todo ello en cumplimiento del RGPD, LOPDGDD y LSSI. El Usuario puede acceder a la política seguida en el tratamiento de los datos personales, así como el establecimiento de las finalidades previamente establecidas, en las condiciones definidas en la Política de Privacidad.
       ...
       <h2>9. COOKIES</h2><br><br>

       La empresa se reserva el derecho de utilizar la tecnología “cookie” en el Espacio Web, a fin de reconocerlo como Usuario frecuente y personalizar el uso que realice del Espacio Web mediante la preselección de su idioma, o contenidos más deseados o específicos.<br><br>

      Las cookies recopilan la dirección IP del usuario siendo Google el responsable del tratamiento de esta información.<br><br>
      ...
      <h2>10. DECLARACIONES Y GARANTÍAS</h2><br><br>
      ...
      <h2>12. RESOLUCIÓN DE CONTROVERSIAS. LEY APLICABLE Y JURISDICCIÓN</h2><br><br>

      Las presentes Condiciones Generales de Uso, así como el uso del Espacio Web, se regirán por la legislación española. Para la resolución de cualquier controversia las partes se someterán a los Juzgados y Tribunales del domicilio social del Responsable del sitio web.<br><br>
